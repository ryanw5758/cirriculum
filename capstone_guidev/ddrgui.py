# Main UI REV 1.3
# 1.3 Changes: functionality to return to main menu, matrix representation with Canvas widget on gameLoop screen, handling for destruction/creation of matrix
